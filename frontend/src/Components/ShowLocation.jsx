        ...
        <div id="battleGround">
            ...
            {enemyPokemon && startBattle && dead_Pokemons_Number != selectedPokemons.length && !deadEnemyPokemon &&
                <>
                    <div id="enemyPokemonHolder">
                        <p style={{ position: "absolute", right: "50%", top: "-30%", color: "white",fontSize:"xx-large", backgroundColor:"rgba(0,0,0,0.5)",borderRadius:"10px", padding:"20px" }} >{enemyPokemon.stats[0].base_stat}</p>
            ...
            {friendlySelectedPokemon && dead_Pokemons_Number != selectedPokemons.length && !deadEnemyPokemon &&
                <div className="friendly_Pokemon_Fighter">
                    <p style={{ position: "absolute", left: "40%", top: "-30%", color: "white", fontSize:"xx-large",  backgroundColor:"rgba(0,0,0,0.5)", borderRadius:"10px", padding:"20px" }} >{friendlySelectedPokemon.stats[0].base_stat}</p>
